...
```
{
	...
	Integer General10;
	Integer Cursor;
	Integer PossessionsBegin;
	Integer PossessionsEnd;
	Integer EquipmentBegin;
	Integer EquipmentEnd;
	Integer GeneralBegin;
	Integer GeneralEnd;
	Integer GeneralBagsBegin;
	Integer GeneralBagsEnd;
	Integer CursorBagBegin;
	Integer CursorBagEnd;
	Integer Tradeskill;
	Integer Augment;
	Integer BankBegin;
	Integer BankEnd;
	Integer BankBagsBegin;
	Integer BankBagsEnd;
	Integer SharedBankBegin;
	Integer SharedBankEnd;
	Integer SharedBankBagsBegin;
	Integer SharedBankBagsEnd;
	Integer BagSlotBegin;
	Integer BagSlotEnd;
	Integer AugSocketBegin;
	Integer AugSocketEnd;
	Integer Invalid;
}
```
